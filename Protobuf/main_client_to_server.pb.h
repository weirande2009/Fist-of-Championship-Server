...
#ifndef GOOGLE_PROTOBUF_INCLUDED_main_5fclient_5fto_5fserver_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_main_5fclient_5fto_5fserver_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_main_5fclient_5fto_5fserver_2eproto
...
struct TableStruct_main_5fclient_5fto_5fserver_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_main_5fclient_5fto_5fserver_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::ChampionFist::C_Participate* Arena::CreateMaybeMessage<::ChampionFist::C_Participate>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ChampionFist {
...
constexpr ClientCommandType ClientCommandType_MAX = C_PARTICIPATE;
...
class C_Participate PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ChampionFist.C_Participate) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ChampionFist.C_Participate";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_main_5fclient_5fto_5fserver_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:ChampionFist.C_Participate)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_main_5fclient_5fto_5fserver_2eproto;
};
// ===================================================================
...
inline const std::string& C_Participate::name() const {
  // @@protoc_insertion_point(field_get:ChampionFist.C_Participate.name)
  return _internal_name();
}
inline void C_Participate::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:ChampionFist.C_Participate.name)
}
inline std::string* C_Participate::mutable_name() {
  // @@protoc_insertion_point(field_mutable:ChampionFist.C_Participate.name)
...
inline void C_Participate::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:ChampionFist.C_Participate.name)
}
inline void C_Participate::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ChampionFist.C_Participate.name)
}
inline void C_Participate::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:ChampionFist.C_Participate.name)
}
...
inline std::string* C_Participate::release_name() {
  // @@protoc_insertion_point(field_release:ChampionFist.C_Participate.name)
...
inline void C_Participate::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ChampionFist.C_Participate.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 C_Participate::hero_no() const {
  // @@protoc_insertion_point(field_get:ChampionFist.C_Participate.hero_no)
...
inline void C_Participate::set_hero_no(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ChampionFist.C_Participate.hero_no)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_main_5fclient_5fto_5fserver_2eproto
