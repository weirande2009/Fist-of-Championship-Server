...
// int32 port = 2;
inline void S_StartGame::clear_port() {
  port_ = 0;
}
inline int32_t S_StartGame::_internal_port() const {
  return port_;
}
inline int32_t S_StartGame::port() const {
  // @@protoc_insertion_point(field_get:ChampionFist.S_StartGame.port)
  return _internal_port();
}
inline void S_StartGame::_internal_set_port(int32_t value) {
  
  port_ = value;
}
inline void S_StartGame::set_port(int32_t value) {
  _internal_set_port(value);
  // @@protoc_insertion_point(field_set:ChampionFist.S_StartGame.port)
}
