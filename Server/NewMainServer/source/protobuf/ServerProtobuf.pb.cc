...
static void InitDefaultsscc_info_C_Establish_ServerProtobuf_2eproto() {
  ...
  {
    void* ptr = &::ChampionFistGame::_C_Establish_default_instance_;
    new (ptr) ::ChampionFistGame::C_Establish();
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ServerProtobuf_2eproto[1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ServerProtobuf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::ChampionFistGame::C_Establish, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::ChampionFistGame::C_Establish, pid_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::ChampionFistGame::C_Establish)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::ChampionFistGame::_C_Establish_default_instance_),
};

const char descriptor_table_protodef_ServerProtobuf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024ServerProtobuf.proto\022\020ChampionFistGame"
  "\"\032\n\013C_Establish\022\013\n\003pid\030\001 \001(\005*$\n\021ServerCo"
  "mmandType\022\017\n\013S_ESTABLISH\020\000*0\n\021ClientComm"
  "andType\022\017\n\013C_ESTABLISH\020\000\022\n\n\006C_OVER\020\001b\006pr"
  "oto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_ServerProtobuf_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ServerProtobuf_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ServerProtobuf_2eproto = {
  false, false, descriptor_table_protodef_ServerProtobuf_2eproto, "ServerProtobuf.proto", 164,
  &descriptor_table_ServerProtobuf_2eproto_once, descriptor_table_ServerProtobuf_2eproto_sccs, descriptor_table_ServerProtobuf_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_ServerProtobuf_2eproto::offsets,
  file_level_metadata_ServerProtobuf_2eproto, 1, file_level_enum_descriptors_ServerProtobuf_2eproto, file_level_service_descriptors_ServerProtobuf_2eproto,
};
...
C_Establish::C_Establish(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:ChampionFistGame.C_Establish)
}
C_Establish::C_Establish(const C_Establish& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  pid_ = from.pid_;
  // @@protoc_insertion_point(copy_constructor:ChampionFistGame.C_Establish)
}
...
C_Establish::~C_Establish() {
  // @@protoc_insertion_point(destructor:ChampionFistGame.C_Establish)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:ChampionFistGame.C_Establish)
...
::PROTOBUF_NAMESPACE_ID::uint8* C_Establish::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:ChampionFistGame.C_Establish)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ChampionFistGame.C_Establish)
  return target;
}

size_t C_Establish::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ChampionFistGame.C_Establish)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:ChampionFistGame.C_Establish)
  GOOGLE_DCHECK_NE(&from, this);
  const C_Establish* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<C_Establish>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:ChampionFistGame.C_Establish)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:ChampionFistGame.C_Establish)
    MergeFrom(*source);
  }
}

void C_Establish::MergeFrom(const C_Establish& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:ChampionFistGame.C_Establish)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:ChampionFistGame.C_Establish)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:ChampionFistGame.C_Establish)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::ChampionFistGame::C_Establish* Arena::CreateMaybeMessage< ::ChampionFistGame::C_Establish >(Arena* arena) {
  return Arena::CreateMessageInternal< ::ChampionFistGame::C_Establish >(arena);
}
