 ...
 * Return: None
 *****************************************/
std::vector<int> ClientPool::GetOnlineFriendFd(const MainClient& client)
{
 ...
 * Return: None
 *****************************************/
std::vector<std::string> ClientPool::GetOnlineFriendName(const MainClient& client)
{
    std::vector<std::string> friend_names = Database::Instance().QueryFriendName(client.player.player_id);
 ...
 * Return: None
 *****************************************/
std::vector<std::string> ClientPool::GetFriendName(const MainClient& client)
{
