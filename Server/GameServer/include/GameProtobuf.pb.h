...
class C_PlayerFrame final :
 ...
 public:
  ...
  ~C_PlayerFrame() override;
  explicit PROTOBUF_CONSTEXPR C_PlayerFrame(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  C_PlayerFrame* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::ChampionFistGame::OperationFrame* release_player_opt_frame();
...
inline ::ChampionFistGame::OperationFrame* UnsyncFrame::add_all_players_opt() {
  ::ChampionFistGame::OperationFrame* _add = _internal_add_all_players_opt();
...
inline int32_t C_Connect::_internal_champion_no() const {
  return champion_no_;
}
inline int32_t C_Connect::champion_no() const {
  // @@protoc_insertion_point(field_get:ChampionFistGame.C_Connect.champion_no)
  return _internal_champion_no();
}
inline void C_Connect::_internal_set_champion_no(int32_t value) {
  
  champion_no_ = value;
}
inline void C_Connect::set_champion_no(int32_t value) {
  _internal_set_champion_no(value);
...
inline int32_t C_PlayerFrame::_internal_frame_id() const {
  return frame_id_;
}
inline int32_t C_PlayerFrame::frame_id() const {
  // @@protoc_insertion_point(field_get:ChampionFistGame.C_PlayerFrame.frame_id)
  return _internal_frame_id();
}
inline void C_PlayerFrame::_internal_set_frame_id(int32_t value) {
  
  frame_id_ = value;
}
inline void C_PlayerFrame::set_frame_id(int32_t value) {
  _internal_set_frame_id(value);
...
inline ::ChampionFistGame::OperationFrame* C_PlayerFrame::_internal_mutable_player_opt_frame() {
  ...
  if (player_opt_frame_ == nullptr) {
    auto* p = CreateMaybeMessage<::ChampionFistGame::OperationFrame>(GetArenaForAllocation());
    player_opt_frame_ = p;
  }
  return player_opt_frame_;
}
inline ::ChampionFistGame::OperationFrame* C_PlayerFrame::mutable_player_opt_frame() {
  ::ChampionFistGame::OperationFrame* _msg = _internal_mutable_player_opt_frame();
...
inline void C_PlayerFrame::set_allocated_player_opt_frame(::ChampionFistGame::OperationFrame* player_opt_frame) {
  ...
  if (player_opt_frame) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(player_opt_frame);
